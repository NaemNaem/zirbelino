...
const base =
  "inline-flex items-center justify-center gap-2 rounded-[var(--radius-craft)] px-5 py-2.5 text-sm font-semibold tracking-wide transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-wood)] disabled:opacity-50";
